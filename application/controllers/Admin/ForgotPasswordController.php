  ...
  public function index()
  {
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      $this->updatePasswordToToken($this->input->post('email'),$token);
           ...
           $mail->isSMTP();
           $mail->HOST = "mail.sudarshantownship.com";
           $mail->SMTPAuth = true;
           $mail->Username = 'team@sudarshantownship.com';
           $mail->Password = 'Welcome@123';
//            $mail->SMTPSecure= 'tls';
//            $mail->port = 587;

           $mail->setFrom('team@sudarshantownship.com','Sudarshan Township');
           $mail->addReplyTo('team@sudarshantownship.com','Sudarshan Township');

           $mail->addAddress($this->input->post('email'));

           $mail->Subject = 'Sudarshan Township Reset Password';

           $mail->isHTML(true);


           $emailContent = '<!DOCTYPE><html><head></head><body>';
           $emailContent .='<h5>Please use the link below to reset your password</h5>';
      ...
      redirect(base_url('account/forgot-password'));
    }
  ...
  public function resetPassword()
  {
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      redirect("account/reset-password","refresh");
    }
  }
